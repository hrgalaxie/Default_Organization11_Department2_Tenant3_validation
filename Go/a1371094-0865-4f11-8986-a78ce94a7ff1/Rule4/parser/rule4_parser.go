...
func NewEmptyLabelContext() *LabelContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = Rule4ParserRULE_label
	return p
}
...
func (s *LabelContext) LABEL() antlr.TerminalNode {
	return s.GetToken(Rule4ParserLABEL, 0)
}
...
func (p *Rule4Parser) Label() (localctx ILabelContext) {
	localctx = NewLabelContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, Rule4ParserRULE_label)
