...
func NewDefaultRule1Lexer(input antlr.CharStream) *DefaultRule1Lexer {

	l := new(DefaultRule1Lexer)
	...
	l.GrammarFileName = "DefaultRule1.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// DefaultRule1Lexer tokens.
const (
	DefaultRule1LexerLABEL    = 1
	DefaultRule1LexerOWNKEY   = 2
	DefaultRule1LexerSPLITKEY = 3
	DefaultRule1LexerWS       = 4
)
